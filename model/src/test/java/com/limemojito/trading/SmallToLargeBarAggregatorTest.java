...
import static com.limemojito.trading.Bar.Period.H1;
import static com.limemojito.trading.Bar.Period.M5;
import static com.limemojito.trading.BarTest.assertBar;
import static com.limemojito.trading.StreamData.REALTIME_UUID;
import static com.limemojito.trading.TickDataLoader.getValidator;
...
public class SmallToLargeBarAggregatorTest {
    ...
    public void shouldFailOnBarsInWrongOrder() {
        ...
        assertThatThrownBy(() -> new SmallToLargeBarAggregator(validator).aggregate(H1, m5Bars)).isInstanceOf(IllegalStateException.class)
                                                                                                .hasMessage(
    ...
    public void shouldAggregateTwelveBarsOk() {
        final List<Bar> m5Bars = ModelPrototype.createBarListDescending(REALTIME_UUID, "EURUSD", M5, 1528174800000L, 12);
    ...
    public void shouldAggregateBarsAcrossPeriodBoundaries() {
        final List<Bar> m5Bars = ModelPrototype.createBarListDescending(REALTIME_UUID, "EURUSD", M5, 1528174800000L, 24);
    ...
    public void shouldAggregateToOddNumberOfPartialBars() {
        final List<Bar> m5Bars = ModelPrototype.createBarListDescending(REALTIME_UUID, "EURUSD", M5, 1528174800000L, 18);
