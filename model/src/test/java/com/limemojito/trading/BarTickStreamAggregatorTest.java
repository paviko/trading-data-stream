...
import static com.limemojito.trading.ModelPrototype.createTick;
...
import static com.limemojito.trading.StreamData.StreamSource.Live;
...
public class BarTickStreamAggregatorTest {
    ...
    public void shouldAggregateOneHourFromDukascopy() throws Exception {
        ...
        BarTickStreamAggregator aggregator = new BarTickStreamAggregator(validator, REALTIME_UUID, symbol, startMillisecondsUtc, period);
        try (DukascopyTickInputStream inputStream = new DukascopyTickInputStream(validator, path, getClass().getResourceAsStream("/" + path))) {
