...
public class BarTickStreamAggregator {
    ...
    public BarTickStreamAggregator(Validator validator, UUID streamId, String symbol, Instant startMillisecondsUtc, Bar.Period period) {
        this(validator, streamId, symbol, startMillisecondsUtc.toEpochMilli(), period);
    }

    public BarTickStreamAggregator(Validator validator, UUID streamId, String symbol, long startMillisecondsUtc, Bar.Period period) {
