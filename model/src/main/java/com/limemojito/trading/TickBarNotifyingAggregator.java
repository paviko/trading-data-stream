...
public class TickBarNotifyingAggregator {
    ...
    private BarTickStreamAggregator createNewAggregatorFor(Bar.Period period,
        ...
        final BarTickStreamAggregator currentAggregator = newAggregator(tick.getStreamId(), tick.getSymbol(), timeIndex, period);
    ...
    private BarTickStreamAggregator newAggregator(UUID streamId, String symbol, long timeIndex, Bar.Period period) {
        ...
        final BarTickStreamAggregator aggregator = new BarTickStreamAggregator(validator, streamId, symbol, startMillisecondsUtc, period);
