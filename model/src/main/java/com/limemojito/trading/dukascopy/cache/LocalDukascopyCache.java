...
public class LocalDukascopyCache extends FallbackDukascopyCache {
     ...
     */
    public static final String PROP_DIR = NoCacheDirectDukascopy.class.getPackageName() + ".localCacheDir";

    private static final Path CACHE_DIR = new File(getProperty(PROP_DIR, getProperty("user.home")), ".dukascopy").toPath();

    public LocalDukascopyCache() {
        this(new NoCacheDirectDukascopy());
    }
